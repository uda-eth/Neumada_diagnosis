...
export default function MessagesPage() {
  ...
  const shareLink = "https://replit.com/join/gvhiemrwto-h"; // This would be dynamic in real usage

  const handleGenerateNewLink = () => {
    // In real usage, this would make an API call to generate a new link
